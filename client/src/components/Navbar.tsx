        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-[72px]">
            ...
            <div className="hidden lg:flex items-center gap-1">
              ...
              <Link href="/contact">
                <button className="ml-4 px-6 py-2.5 bg-[#144A92] text-white font-medium text-[13px] rounded-lg transition-all duration-300 hover:shadow-md hover:scale-[1.03] active:scale-[0.98] border border-white/80 hover:border-white">
                  Get a Quote
                </button>
              </Link>
            </div>
